...
$(document).ready(function () {
    ...
    $("#btnModal").on("click", function () {
        if (document.body.querySelectorAll("table td:nth-child(1),table td:nth-child(2)").length == 0) {
            obj.Beneficiario.forEach(function (beneficiario, index) {
                IncluirBeneficiarioTable(beneficiario.CPF, beneficiario.Nome);
            });
...
function IncluirBeneficiarioTable(cpf, nome) {

    if (cpf == null || nome == null) {
         cpf = $('#InputCPFBenef').val();
         nome = $("#InputNomeBenef").val();
    }
