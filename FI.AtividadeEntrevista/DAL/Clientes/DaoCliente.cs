...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBenef : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            {
                beneficiariosJson = JsonConvert.SerializeObject(cliente.Beneficiario);
            }
            else
            {
                beneficiariosJson = JsonConvert.SerializeObject(new List<Beneficiario>());
            }
        ...
        internal long IncluirBenef(DML.Cliente cliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
